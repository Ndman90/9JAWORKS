export function createWelcomeEmailTemplate(name, profileUrl) {
  ...
  <body style="font-family: Arial, sans-serif; line-height: 1.6; color: #333; max-width: 600px; margin: 0 auto; padding: 20px;">
    <div style="background: linear-gradient(to right, #009C22, #009C22); padding: 30px; text-align: center; border-radius: 10px 10px 0 0;">
      <img src="public/logo.png" alt="9JAWORKS Logo" style="width: 150px; margin-bottom: 20px;border-radius: 10px;">
...
<body style="font-family: Arial, sans-serif; line-height: 1.6; color: #333; max-width: 600px; margin: 0 auto; padding: 20px;">
  <div style="background: linear-gradient(to right, #009C22, #009C22); padding: 30px; text-align: center; border-radius: 10px 10px 0 0;">
    <img src="public/logo.png" alt="UnLinked Logo" style="width: 150px; margin-bottom: 20px;border-radius: 10px;"/>
